    ...
    if ($('.pagenav__button--left').length > 0) {
        ...
        (function () {
            ...
            function switchLink(btn) {
				...
				window.history.pushState(null, null, '#'+btn.getAttribute('data-url'));
...
//========= POPUP for room-options =========
    ...
    $(window).on('resize', function () {
        ...
        if (width > 700 && listSlid.length <= 0) {
            console.log($("#room-options__list"))
            $('#room-options__list').slick(slickOption);
...
//========= script for FLOOR_page =========
    if ($(".svg_polygon").length > 0) {
        ...
        function getCoords(elem) { // ÐºÑ€Ð¾Ð¼Ðµ IE8-
...
//========= script for LINKS-HIDE =========
    ...
    function linksHide() {
        ...
        console.dir($(".page--current > .apartment").length > 0);
        ...
        } else if ($(".page--current > .advantage").length > 0 || $(".page--current > .documents").length > 0 || $(".page--current > .news").length > 0 || $(".page--current > .contact").length > 0 || $(".page--current > .web-cam").length > 0 || $(".page--current > .news").length > 0 || $(".page--current > .news-page").length > 0) {

...
//========= SCROLL bar for ROOMS_PAGE =========
	jQuery(function () {
		jQuery('.rooms__description').jScrollPane({
...
//========= SCROLL bar for LOCATION_PAGE =========
	jQuery(function () {
		jQuery('.location__description').jScrollPane({
			verticalDragMinHeight: 13,
			verticalDragMaxHeight: 13,
			verticalGutter: 2
		})
...
//========= SCROLL bar for HOUSE_PAGE =========
	jQuery(function () {
		jQuery('.house__description').jScrollPane({
			verticalDragMinHeight: 13,
			verticalDragMaxHeight: 13,
			verticalGutter: 2
		})
...
//========= SCROLL bar for ARCHITECTURE_PAGE =========
	jQuery(function () {
		jQuery('.architecture__description').jScrollPane({
			verticalDragMinHeight: 13,
			verticalDragMaxHeight: 13,
			verticalGutter: 2
		})
...
//========= SCROLL bar for VALUES_PAGE =========
	jQuery(function () {
		...
		jQuery('.values-scroll').jScrollPane({
			verticalDragMinHeight: 13,
			verticalDragMaxHeight: 13,
			verticalGutter: 2
		});
...
//========= SCROLL bar for NEWS-PAGE =========
	jQuery('.news-page__description-wrap').jScrollPane({
		verticalDragMinHeight: 13,
		verticalDragMaxHeight: 13,
		verticalGutter: 2
	});
...
//========= SCROLL bar for OPTIONS_PAGE =========
	jQuery('.options__filter-inner').jScrollPane({
		verticalDragMinHeight: 13,
		verticalDragMaxHeight: 13,
		verticalGutter: 2
	});
...
//========= maska
$(document).on('change', '.error', function (e) {$(this).removeClass('error')})

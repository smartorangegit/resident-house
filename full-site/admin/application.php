...
// Проверяем установлен ли массив файлов и массив с переданными данными
        //if (isset($_FILES) && isset($_FILES['image'])) {
			...
			$dumpPathImg = $dirImgName.$dotExplode[0].'.'.$dotExplode[1];
			//НЕ працює! $dumpPathImg = $cropImg.$dotExplode[0].'.jpg';
            $finPathImg = $structure.'/'.$files_dump[0];
            //print_r($dotExplode);
            //echo $dumpPathImg;
			
			echo '<pre>'; print_r($dumpPathImg); echo '</pre>';
			
				echo '<pre>'; print_r($finPathImg); echo '</pre>';

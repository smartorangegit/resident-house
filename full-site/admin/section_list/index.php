...
<div class="container">
    <form id="updSect">
        ...
        <div class="section">
            <label>Секиця № </label>
            <button class="filter btn" id="1*sec">1</button>
            <button class="filter btn" id="2*sec">2</button>
            <button class="filter btn" id="3*sec">3</button>
        </div>
        <div class="section">
            <label>Дом № </label>
            <button class="filter btn" id="1*build">1</button>
            <button class="filter btn" id="2*build">2</button>
            <button class="filter btn" id="3*build">3</button>
        </div>
        <?
